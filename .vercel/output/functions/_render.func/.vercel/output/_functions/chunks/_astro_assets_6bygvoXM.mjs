...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_B8Ch1nCA.mjs'
    ).then(n => n.a1).catch((e) => {
...
}, "/Users/nourallam/blog/node_modules/astro/components/Image.astro", undefined);
...
}, "/Users/nourallam/blog/node_modules/astro/components/Picture.astro", undefined);
